...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(com.guochang.interviewpracticebackend.exception.BusinessException.class)
    public BaseResponse<?> businessExceptionHandler(com.guochang.interviewpracticebackend.exception.BusinessException e) {
